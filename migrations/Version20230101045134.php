 ...
 */
final class Version20230101045134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post ADD category_id INT DEFAULT NULL, ADD prix DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post DROP category_id, DROP prix');
    }
}
